...
<head>
    ...
    <style>
        * {
        ...
        /* Fixed Background Image Overlay (Matching your core theme) */
        .background-overlay {
            position: fixed;
            top: 0;
            left: 0;
        ...
        .navbar {
            ...
            border-bottom: 2px solid #8e44ad; /* Royal Purple Border */
            height: 10vh;
        }
        ...
        .menu a:hover, .menu a.active {
            color: #bb86fc; /* Bright neon purple for hover states */
        }
        ...
        /* Transparent Royal Purple Glassmorphism Container */
        .form-container {
            background: rgba(255, 255, 255, 0.07); /* Semi-transparent white */
            backdrop-filter: blur(12px); /* Blurs background image underneath */
            -webkit-backdrop-filter: blur(12px);
            padding: 40px;
            border-radius: 16px;
            width: 100%;
            max-width: 450px; /* Slimmer card for balance inquiry */
            box-shadow: 0 8px 32px rgba(142, 68, 173, 0.25); /* Subtle purple neon shadow */
        ...
        .form-container h2 {
            color: #bb86fc; /* Neon Purple Header */
            margin-bottom: 8px;
            font-size: 26px;
        }
        ...
        .input-group input {
            width: 100%;
            padding: 12px;
            background: rgba(255, 255, 255, 0.95); /* High readability input */
...
<body>
    <!-- Deep purple-tinted transparent background overlay -->
    <div class="background-overlay"></div>
    
    <!-- Connected Navbar (Pointing to your capital-H dashboard file) -->
    <nav class="navbar">
